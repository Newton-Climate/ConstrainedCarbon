...
from ecosystem_complexity.model.state import _LAMBDA_14C, ModelParams
from ecosystem_complexity.processes.radiocarbon import _R_STD, respired_delta14C
...
if TYPE_CHECKING:
    ...
    # ``from __future__ import annotations``.
    from ecosystem_complexity.model.api import ModelOutput
